          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><?php echo $_GET[leg_type];?> Leg List</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo $_GET[leg_type];?> Leg List</h2>
...
$sel1="SELECT * FROM `distributor` WHERE `placement_id`='$tr';";
$que1=$con->query($sel1);
$c=$que1->num_rows;
if($c!=0){
