...
include "config.php";
if($_GET[n]=='s'){
    top_structure('KYC', 1, 'success', 'Success!', 'Document Submitted Successfully !! Verfication under process');
 }//elseif($_GET[n]=='n'){
//     top_structure('KYC', 1, 'warning', 'Not Matched', 'Old Password Is Incorrect');
// }
elseif($_GET[n]=='f'){
    top_structure('KYC', 1, 'error', 'Failed!', 'Plz Try Again! Query Failed');
}
else{
    top_structure('KYC', 0, '', '', '');
}
//top_structure('Index || Getmii', 1, 'warning', 'Success', 'done');
sidebar();
header_bar();?>
<!--Content-->
                    ...
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="number" class="form-control" name="acc_no" required placeholder="Bank Account No.">
                          <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" class="form-control" name="ifsc" required placeholder="IFSC Code">
                          <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                      </div>
                      <div class="form-group">
...
<?php } } ?>
   ...
   ////////////////////////////////////////////////////////////////////////////
		...
		if(move_uploaded_file($_FILES["adharb"]["tmp_name"], "adhar_card_img/".$_SESSION['d_id']."b.jpg"))
		{
            ...
            {
            echo "<script>
		location.href='kyc.php?n=s';</script>";
            }
            else{ echo "<script>
		location.href='kyc.php'?n=f;</script>";}
            }
            }
            }
  ///////////////////////////////////////////////
