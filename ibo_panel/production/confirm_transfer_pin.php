...
<html lang="en">
  <head>
    ...
    <title>UBW || Confirm Transfer Pin Wallet</title>
  ...
  <body class="nav-md">
    ...
    for ($index=0;$index<strlen($string);$index++) {
        if(isNumber($string[$index]))
        {
            ...
            <tr><th>Pin Type</th><td><?php echo $_POST[pin_type];?></td></tr>
           ...
           <form action="process_transfer_pin.php" method="post">
               ...
               <input type="hidden" name="pin_type" value="<?php echo $_POST[pin_type];?>">
