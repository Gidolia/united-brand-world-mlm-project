...
include "config.php";
if($_GET[a]=="s"){
top_structure('All users', 1, 'success', 'Amount Added', '');    
}elseif($_GET[a]=="f"){
top_structure('All users', 1, 'danger', 'Added Fail', '');    
}elseif($_GET[r]=="s"){
top_structure('All users', 1, 'success', 'Amount Removed', '');    
}elseif($_GET[r]=="f"){
top_structure('All users', 1, 'danger', 'Removal Fail', '');    
}else{
top_structure('All users', 0, 'warning', 'Success', 'done');    
}
